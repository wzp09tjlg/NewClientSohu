package com.sina.home.testfor_newclient.widget.pullRefresh.View.LoadingLayout;
...
import com.sina.home.testfor_newclient.widget.pullRefresh.Base.LoadingLayout;
...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mArrowImageView.setImageResource(R.drawable.icon_refresh_rotate);
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.layout_pull_to_refresh_header_new, null);
        return container;
    }
    ...
    static class ImageViewRotationHelper {
        ...
        public void setRotation(float rotation){
            if (Build.VERSION.SDK_INT > 10) {  //  //APIUtils.hasHoneycomb();  hasHoneycomb  --  11
